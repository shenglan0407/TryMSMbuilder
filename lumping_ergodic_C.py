...
micro_msm_path = '/home/shenglan/TryMSMbuilder/output/C/ergodic/KC_msm_'+model+'.out'
micro_msm = pickle.load(open(micro_msm_path,'rb'))

geo_assign_path = '/home/shenglan/TryMSMbuilder/output/C/ergodic/KC_assign_'+model+'.out'
