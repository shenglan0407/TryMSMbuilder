...
for n in n_states:
    ...
    for lag_time in lag_times:
        this_msm = MarkovStateModel(lag_time=lag_time,sliding_window = True, verbose=False).fit(assignments)
...
# Save data
#----------------------------------------------------------------------------------
msm_path = '/home/shenglan/TryMSMbuilder/output/C/ergodic/KC_msm_c'+str(N_CLUSTER)+'_s'+str(LOAD_STRIDE)+'.out'
pickle.dump(msm,open(msm_path,'wb'))

seq_path = '/home/shenglan/TryMSMbuilder/output/C/ergodic/sequences'+'_s'+str(LOAD_STRIDE)+'.out'
pickle.dump(sequences_all,open(seq_path,'wb'))

assign_path = '/home/shenglan/TryMSMbuilder/output/C/ergodic/KC_assign_c'+str(N_CLUSTER)+'_s'+str(LOAD_STRIDE)+'.out'
pickle.dump(assignments,open(assign_path,'wb'))

countsmat_path = '/home/shenglan/TryMSMbuilder/output/C/ergodic/KC_countsmat_c'+str(N_CLUSTER)+'_s'+str(LOAD_STRIDE)+'.out'
np.savetxt(countsmat_path,countsmat,fmt = '%8.4g')

transmat_path = '/home/shenglan/TryMSMbuilder/output/C/ergodic/KC_transmat_c'+str(N_CLUSTER)+'_s'+str(LOAD_STRIDE)+'.out'
np.savetxt(transmat_path,transmat,fmt = '%10.4g')

centers_path = '/home/shenglan/TryMSMbuilder/output/C/ergodic/KC_centers_c'+str(N_CLUSTER)+'_s'+str(LOAD_STRIDE)+'.out'
np.savetxt(centers_path,centers,fmt = '%10.4g')

#----------------------------------------------------------------------------------
# Convert to pdb
#----------------------------------------------------------------------------------
pdb_path = '/home/shenglan/TryMSMbuilder/output/C/ergodic/KC_c'+str(N_CLUSTER)+'_s'+str(LOAD_STRIDE)+'.pdb'
...
plt.savefig('/home/shenglan/TryMSMbuilder/output/C/ergodic/lagtime_ts1.png')
plt.close(fig4)
...
plt.savefig('/home/shenglan/TryMSMbuilder/output/C/ergodic/lagtime_ts2.png')
plt.close(fig6)
...
plt.savefig('/home/shenglan/TryMSMbuilder/output/C/ergodic/lagtime_ts3.png')
plt.close(fig7)
